    ...
    >
      {loading ? (
        ...
        <Box textAlign="center">
          ...
          Sorry, after more detailed qualification check, you were not a good fit for this study.
          </Typography>
        </Box>
      )}
    </Container>
...
export default SurvetCloseRedirectPage;
